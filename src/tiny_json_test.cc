...
TEST(TestJson, test_parse_number) {
    ...
    TEST_PARSE_NUMBER(1.0000000000000002, "1.0000000000000002");
    /* minimum denormal */
...
TEST(TestJson, test_parse_error) {
    ...
    TEST_PARSE_ERROR(JSON_PARSE_INVALID_VALUE, ".123");
    TEST_PARSE_ERROR(JSON_PARSE_INVALID_VALUE, "1.");
    ...
    /* invalid number */
    TEST_PARSE_ERROR(JSON_PARSE_NOT_SINGLE_VALUE, "0123");
...
TEST(TestJson, test_stringify) {
    ...
    TEST_STRINGIFY("1.0000000000000002");
